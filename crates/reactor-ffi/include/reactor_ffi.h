 ...
 *   ready_timeout_seconds — grace past the runtime's own prediction.  Negative
 *                           waits as long as the session lives, which is the only
 *                           sane answer for a model generating slower than real
 *                           time.
