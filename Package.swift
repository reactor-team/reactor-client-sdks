...
// swift-format-ignore
let releasedFFI: (url: String, checksum: String)? = (url: "https://github.com/reactor-team/reactor-client-sdks/releases/download/v0.0.0-dev/ReactorFFI.xcframework.zip", checksum: "004c62eef31b222330625921125bb6853647751434aa8c53e0bb33c71b48928d")
