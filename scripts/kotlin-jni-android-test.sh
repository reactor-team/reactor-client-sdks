...
./gradlew --no-daemon :native-probe:connectedDebugAndroidTest \
  -Pandroid.testInstrumentationRunnerArguments.class=inc.reactor.sdk.internal.NativeBoundaryTest,inc.reactor.sdk.internal.LifecycleTest,inc.reactor.sdk.internal.MediaReceiveTest,inc.reactor.sdk.internal.MediaSendTest
