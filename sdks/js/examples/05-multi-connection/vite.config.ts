...
// Must match `main.ts`'s `MODEL_NAME`. Both clients share this one model —
// the joiner adopts the creator's session rather than creating its own.
  ...
  plugins: [
    {
      ...
      configureServer(server) {
        ...
        //
        // Both clients on the page resolve their JWT through this same
        // endpoint — that's fine, they don't need distinct tokens, only the
        // creator actually creates a session.
