...
|---|---|---|
| Linux x86_64 | `reactor-sdk-cpp-2.0.1-linux-x64.tar.gz` | glibc 2.34+ (Ubuntu 22.04, Debian 12, RHEL 9, Amazon Linux 2023) |
| Linux aarch64 | `reactor-sdk-cpp-2.0.1-linux-arm64.tar.gz` | glibc 2.34+ |
| macOS arm64 | `reactor-sdk-cpp-2.0.1-macos-arm64.tar.gz` | macOS 11+ |
| macOS x86_64 | `reactor-sdk-cpp-2.0.1-macos-x64.tar.gz` | macOS 13+ — libwebrtc's floor on this architecture |
| Windows x86_64 | `reactor-sdk-cpp-2.0.1-windows-x64.zip` | Windows 10+ |
...
```bash
tar xzf reactor-sdk-cpp-2.0.1-linux-x64.tar.gz
cmake -S . -B build -DCMAKE_PREFIX_PATH=$PWD/reactor-sdk-cpp-2.0.1-linux-x64
```
